...
**Specification version:** 0.4.12  
**Codebase version:** 0.4.12  
...
## v0.4.12 Geometry Viewer Fast mode

Geometry Viewer includes a **Fast mode** checkbox, enabled by default. Fast mode affects only non-selected/background copper. It draws other nets as topology-preserving simplified outlines to improve pan/zoom responsiveness. Selected Net A and Net B, minimum-distance markers, measurement lines, overlap geometry and blocker-dot markers remain drawn by the exact renderer.
