...
> **Note (v0.4.15+):** the deterministic **Voltage Guessing** feature has its own manual: `voltage_guessing_user_manual_v0.4.22.md`, API reference: `voltage_guessing_api_reference_v0.4.22.md`.
