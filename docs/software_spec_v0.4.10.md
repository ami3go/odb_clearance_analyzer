...
**Specification version:** 0.4.10  
**Codebase version:** 0.4.10  
...
## v0.4.10 Accurate Copper-Pour Rendering Fix

Geometry Viewer shall not simplify copper-pour polygons by blindly dropping vertices. Dense PCB polygon contours may contain narrow clearances, anti-pads, self-touching boundaries, and highly detailed zone edges. Index-based decimation can create false diagonal edges and incorrect-looking ground polygon geometry. The viewer keeps normal contours exact and only uses topology-preserving simplification for extremely large display contours.
